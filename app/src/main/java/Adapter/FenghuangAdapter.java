...
*/
public class FenghuangAdapter extends RecyclerViewBaseAdapter<FenghuangBean>{
    private Context context;
    private LayoutInflater inflater;

    public FenghuangAdapter(Context context, List<FenghuangBean> mItemDataList) {
        super(mItemDataList);
    ...
    @Override
    public void showData(RecyclerViewHolderBase viewHolder, int i, List<FenghuangBean> mItemDataList) {
        //向下转型为子类
