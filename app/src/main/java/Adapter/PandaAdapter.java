...
*/
public class PandaAdapter extends RecyclerViewBaseAdapter<PandaBean>{
    private Context context;
    private LayoutInflater inflater;

    public PandaAdapter(Context context, List<PandaBean> mItemDataList) {
        super(mItemDataList);
    ...
    @Override
    public void showData(RecyclerViewHolderBase viewHolder, int i, List<PandaBean> mItemDataList) {
        //向下转型为子类
