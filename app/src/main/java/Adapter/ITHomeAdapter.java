...
*/
public class ITHomeAdapter extends RecyclerViewBaseAdapter<ITHomeBean>{
    private Context context;
    private LayoutInflater inflater;

    public ITHomeAdapter(Context context, List<ITHomeBean> mItemDataList) {
        super(mItemDataList);
    ...
    @Override
    public void showData(RecyclerViewHolderBase viewHolder, int i, List<ITHomeBean> mItemDataList) {
        //向下转型为子类
