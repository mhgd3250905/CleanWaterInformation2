...
*/
public class V2exAdapter extends RecyclerViewBaseAdapter<V2EXBean>{
    private Context context;
    private LayoutInflater inflater;

    public V2exAdapter(Context context, List<V2EXBean> mItemDataList) {
        super(mItemDataList);
    ...
    @Override
    public void showData(RecyclerViewHolderBase viewHolder, int i, List<V2EXBean> mItemDataList) {
        //向下转型为子类
